...
class ShareBoardFragment : Fragment() {
    private lateinit var binding: FragmentShareBoardBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentShareBoardBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun initRecyclerView(){
        ...
        adapter = ShareBoardAdapater(requireContext())
...
class ShareBoardAdapater(val context: Context) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
...
class ShareBoardViewHolder(private val binding: RowShareBoardBinding, var context: Context): RecyclerView.ViewHolder(binding.root) {
    fun bind(data :ShareBoardData){
        ...
        binding.root.setOnClickListener{
            context.startActivity(Intent(context, BoardDetail::class.java))
        }
